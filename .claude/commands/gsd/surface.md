...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/.gsd-surface.json`
(sibling to `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/skills`).
...
`/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/.gsd-surface.json`
Install profile marker: `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/.gsd-profile`
Skill dirs: `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/skills/gsd-*/`
Engine module: `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
