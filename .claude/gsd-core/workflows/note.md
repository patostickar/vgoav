...
- **Global scope**: `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/notes/`)
...
2. Glob `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/notes/` — works in any directory
