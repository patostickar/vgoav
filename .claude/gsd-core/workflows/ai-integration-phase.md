...
<required_reading>
@/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/references/ai-frameworks.md
@/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/agents/gsd-eval-planner.md for instructions.
