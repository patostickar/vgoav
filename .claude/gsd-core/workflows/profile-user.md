...
Key references:
- @/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/references/ui-brand.md (display patterns)
- @/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/USER-PROFILE.md" "/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/references/user-profiling.md`
...
Reference: @/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/CLAUDE.md
```
