...
INSTALL_JS_GLOBAL="/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
