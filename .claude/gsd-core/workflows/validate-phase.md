...
```
Agent(
  prompt="Read /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/templates/VALIDATION.md`
