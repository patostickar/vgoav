...
The keys live in `.claude/settings.json` (project) or `/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/settings.json` (global) — **not** in `.planning/config.json`:
