...
- Usage: Reference from command with `@/home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/patricio.stickar/Documents/viking-gauchos-on-a-vespa/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
